...
class Housing_Resources():
    ...
    def createTable(self,location):
        self.cur.execute('create table {}(type varchar(1000),addr varchar(1000),price varchar(100),url varchar(1000),index(price),unique(url))default charset=utf8;'.format(location))
